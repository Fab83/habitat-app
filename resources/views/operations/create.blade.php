            ...
            <form action="{{ route('operations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-content" id="operationTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="operation" role="tabpanel">
                        <div class="container roundForm" style="border:solid 1px #646970;">
                            @csrf
                            <div class="row g-2">
                                {{-- Nom --}}
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="nom_operation" id="nom_operation"
                                        class="form-control form-control-sm" value="{{ old('nom_operation') }}"
                                        required>
                                </div>
                                {{-- Année prog --}}
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" name="annee_prog" id="année_prog"
                                        class="form-control form-control-sm" value="{{ old('annee_prog') }}">
                                </div>
                                {{-- Livraison --}}
                                <div class="col-md-3">
                                    <label for="dateLivraison" class="form-label">Année livraison</label>
                            ...
                            <div class="row g-2">
                                <div class="mb-3">
                                    <label class="form-label>" style="margin-right:10px">Etat d'avancement</label>
                                    <div class=" form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="etat_avancement"
                                            id="projet" value="Projet" checked>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="adresse_operation" id="adresse"
                                        class="form-control form-control-sm" value="{{ old('adresse_operation') }}"
                                        required>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="inventaire_sru"
                                            id="nd" value="SRU non renseigné" checked>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="date_pc" id="date_pc"
                                        class="form-control form-control-sm" value="{{ old('date_pc') }}">
                                </div>
                            </div>
                            <div class="row g-2">
                                <div class="col-md-2">
                                    ...
                                    <input type="file" name="pc" id="pc"
                                        class="form-control form-control-sm" value="{{ old('pc') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane fade" id="logement" role="tabpanel">
                        <div class="container roundForm" style="border:solid 1px #646970 !important;">
                            <p class="fs-2 mb-3">Locatif - Agréments</p>
                            <div class="row g-2">
                    ...
                    {{-- Onglet Garanties --}}
                    <div class="tab-pane" id="garantie" role="tabpanel">
                        <div class="container roundForm" style="border:solid 1px #646970;">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="montant_plai_foncier" class="form-label">Montant PLAI
                                        Foncier</label>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="montant_pls_construction" class="form-label">Montant PLS
                                        Construction</label>
                                    <input type="text" name="montant_pls_construction"
                                        id="montant_pls_construction" class="form-control form-control-sm"
                                        oninput="this.value = this.value.replace(/\D/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, ' ');">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="montant_pls_foncier" class="form-label">Montant PLS
                                        Foncier</label>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="montant_phb2" id="montant_phb2"
                                    class="form-control form-control-sm"
                                    oninput="this.value = this.value.replace(/\D/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, ' ');">
                            </div>
                            <div class="col-md-3 mb-3">
